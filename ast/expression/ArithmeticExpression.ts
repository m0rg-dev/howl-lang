...
export class ArithmeticExpression extends ExpressionElement {
    ...
    clone() {
        return new ArithmeticExpression(this.source_location, this.lhs.clone() as ExpressionElement, this.rhs.clone() as ExpressionElement, this.what);
    }
}
