...
public class MacroCallExpression extends CallExpressionBase {
    ...
    public LLVMValue generate(LLVMBuilder builder) {
         ...
         * return
         * builder.buildSizeofHack(this.args.get(0).getResolvedType().generate(builder.
         * getModule()));
         ...
         * LLVMType ppi8 = new LLVMPointerType<>(new LLVMPointerType<>(new
         * LLVMIntType(builder.getContext(), 8)));
         ...
         * return builder
         * .buildBitcast(builder.buildLoad(builder.buildStructGEP(source_type.generate(
         * builder.getModule()),
         * source_alloca, 1,
         ...
         * new LLVMPointerType<>(new LLVMPointerType<>(new
         * LLVMIntType(builder.getContext(), 8))),
         * ""));
